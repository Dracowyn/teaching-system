export default {
    ...
    'Please enter the correct account': 'The account requires 3 to 15 characters and must start with a letter and only contain Chinese, letters, numbers, and underscores',
