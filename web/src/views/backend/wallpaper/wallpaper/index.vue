<template>
    <div class="default-main ba-table-box">
        ...
        <TableHeader
            ...
            :quick-search-placeholder="t('Quick search placeholder', { fields: t('wallpaper.wallpaper.quick Search Fields') })"
        ></TableHeader>
...
const baTable = new baTableClass(
    new baTableApi('/admin/wallpaper.Wallpaper/'),
    {
        ...
        column: [
            ...
            { label: t('wallpaper.wallpaper.image'), prop: 'image', align: 'center', render: 'image', operator: false },
