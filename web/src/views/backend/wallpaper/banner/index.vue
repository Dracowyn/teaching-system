<template>
    <div class="default-main ba-table-box">
        ...
        <TableHeader
            ...
            :quick-search-placeholder="t('Quick search placeholder', { fields: t('wallpaper.banner.quick Search Fields') })"
        ></TableHeader>
...
const baTable = new baTableClass(
    new baTableApi('/admin/wallpaper.Banner/'),
    {
        pk: 'id',
        column: [
            { type: 'selection', align: 'center', operator: false },
            { label: t('wallpaper.banner.pic'), prop: 'pic', align: 'center', render: 'image', operator: false },
            { label: t('wallpaper.banner.sort'), prop: 'sort', align: 'center', operator: 'RANGE', sortable: 'custom' },
            { label: t('wallpaper.banner.classify__name'), prop: 'classify.name', align: 'center', render: 'tags', operator: false },
            { label: t('wallpaper.banner.classify__name'), prop: 'classify_id', align: 'center', operator: 'FIND_IN_SET', show: false, comSearchRender: 'remoteSelect', remote: { pk: 'classify.id', field: 'name', remoteUrl: '/admin/wallpaper.Classify/index', multiple: true } },
