...
const baTable = new baTableClass(
    new baTableApi('/admin/news.News/'),
    {
        ...
        column: [
            ...
            { label: t('news.anthor'), prop: 'anthor', align: 'center', operatorPlaceholder: t('Fuzzy query'), operator: 'LIKE', sortable: false },
            { label: t('news.hits'), prop: 'hits', align: 'center', operator: 'RANGE', sortable: false },
            { label: t('news.category'), prop: 'category', align: 'center', render: 'tag', operator: 'eq', sortable: false, replaceValue: { opt0: t('news.category opt0'), opt1: t('news.category opt1') } },
            ...
            { label: t('news.update_time'), prop: 'update_time', align: 'center', render: 'datetime', operator: 'RANGE', sortable: 'custom', width: 160, timeFormat: 'yyyy-mm-dd hh:MM:ss' },
